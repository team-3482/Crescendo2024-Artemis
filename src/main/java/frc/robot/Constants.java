...
public final class Constants {
    ...
    public static final class SwerveKinematics {
        ...
        public static final double PHYSICAL_MAX_MODULE_SPEED = 5; // This value should be greater than DRIVE_SPEED_COEFFICENT
        /** Multiplied by the value given by the slew rate limiter for driving ; basically the top speed reachable*/
        public static final double DRIVE_SPEED_COEFFICENT = 4; // This value should be lower than PHYSICAL_MAX_MODULE_SPEED
